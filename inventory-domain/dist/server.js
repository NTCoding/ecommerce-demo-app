...
subscribeToEvent('OrderPlaced', (event) => handleOrderPlaced(event, reserveInventoryUseCase, inventoryItems));
subscribeToEvent('OrderCancelled', (event) => handleOrderCancelled(event, releaseInventoryUseCase, inventoryItems));
app.listen(PORT, () => {
