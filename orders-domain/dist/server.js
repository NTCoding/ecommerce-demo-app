...
subscribeToEvent('InventoryReserved', (event) => handleInventoryReserved(event, confirmAfterInventoryUseCase));
subscribeToEvent('PaymentCompleted', (event) => handlePaymentCompleted(event, confirmAfterPaymentUseCase));
subscribeToEvent('ShipmentDelivered', (event) => handleShipmentDelivered(event, completeOrderUseCase));
app.listen(PORT, () => {
